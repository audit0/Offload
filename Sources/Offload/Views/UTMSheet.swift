    ...
    private var steps: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            step(2, "Перенести на внешний диск",
                 "В UTM: правый клик → «Переместить…» (Move…) и выберите папку в сейфе или на диске. UTM скопирует машину, удалит оригинал и запомнит новое место. Перед запуском такой машины подключите диск и откройте сейф — иначе UTM покажет её недоступной.")
